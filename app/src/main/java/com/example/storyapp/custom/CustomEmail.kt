...
class CustomEmail : AppCompatEditText, View.OnTouchListener {
    ...
    private fun init() {
        ...
        passwordIcon = ContextCompat.getDrawable(context, R.drawable.ic_email) as Drawable
        clearButtonImage = ContextCompat.getDrawable(context, R.drawable.ic_close) as Drawable
        warning = ContextCompat.getDrawable(context, R.drawable.emailwarning) as Drawable
